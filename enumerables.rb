...
def spiciest_foods(spicy_foods)
  # your code here
  spicy_list = spicy_foods.find_all{|food| food[:heat_level] > 5}
end
...
def print_spicy_foods(spicy_foods)
  # your code here
  show_spicyt = spicy_foods.map do |food|
...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  found_food = spicy_foods.detect do |food|
...
def sort_by_heat(spicy_foods)
  # your code here
  #I solved this with spaceship and sort_by
